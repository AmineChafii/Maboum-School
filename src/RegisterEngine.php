...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt_check_email->rowCount() > 0) {
        $_SESSION['error'] = "L'adresse e-mail existe déjà.";
        ...
        $type_soutien = implode(", ", $_POST['type']);
        $matiere = isset($_POST['matiere']) ? implode(", ", $_POST['matiere']) : '';
        $campus = $_POST['campus'];
        ...
        try{
            ...
            $mail->Body = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                            ...
                            <p class="t12" style="margin:0;Margin:0;font-family:Albert Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;line-height:21px;font-weight:400;font-style:normal;font-size:16px;text-decoration:underline;text-transform:none;letter-spacing:-0.64px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Attention, ce code ne sera plus valide apr&eacute;s 30 minutes !</p></td>
                            </tr></table>
                            ...
                            <div style="font-size:0px;"><img class="t17" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="64.60000000000001" height="68.3125" alt="" src="https://tabular.b-cdn.net/u/b2282f02-0b38-4f7c-8893-0928a5316785/c189d411-ff36-4673-a529-3c2f08186f17.png"/></div></td>
                            </tr></table>
                            </td></tr></table></td>
                            </tr></table>
                            ...
                            <td class="t26"><div style="font-size:0px;"><img class="t24" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="29" height="29" alt="" src="https://30d61d41-387a-436d-b448-d68c6fabeab0.b-cdn.net/e/a8b82150-c259-48cb-9f0e-14e8ddca3588/cc3f4b40-5683-4e43-ba81-a6d0fe199ff8.png"/></div></td>
                            </tr></table>
                            </div></div>
                            <!--[if mso]>
                            ...
                            <td class="t32"><div style="font-size:0px;"><img class="t30" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="29" height="29" alt="" src="https://30d61d41-387a-436d-b448-d68c6fabeab0.b-cdn.net/e/a8b82150-c259-48cb-9f0e-14e8ddca3588/cca49cfe-0010-4225-b786-742680fe9589.png"/></div></td>
                            </tr></table>
                            </div></div>
                            <!--[if mso]>
                            ...
                            <td class="t38"><div style="font-size:0px;"><img class="t36" style="display:block;border:0;height:auto;width:100%;Margin:0;max-width:100%;" width="29" height="29" alt="" src="https://30d61d41-387a-436d-b448-d68c6fabeab0.b-cdn.net/e/a8b82150-c259-48cb-9f0e-14e8ddca3588/f0cc4bd6-67cf-4e25-9d4e-f3860fba2d1d.png"/></div></td>
                            </tr></table>
                            </div></div>
                            <!--[if mso]>
            ...
            $_SESSION['type_soutien'] = implode(", ", $_POST['type']);
            $_SESSION['matiere'] = isset($_POST['matiere']) ? implode(", ", $_POST['matiere']) : '';
            ...
            $sql1 = "INSERT INTO client(verification_code, email_verified_at) VALUES ('" . $verification_code ."',  NULL)";
        ...
        if (isset($_POST['autre']) && !empty($_POST['autreMatiere'])) {
            $autreMatiere = $_POST['autreMatiere'];
            $matiere .= ": " . $autreMatiere; 
        }
